...
const offerings = [
  {
    label: 'Offering 02', title: 'Turn your messy documents into SaaS academy', price: 'Let’s talk', duration: 'A complete academy foundation, built with you', featured: true,
